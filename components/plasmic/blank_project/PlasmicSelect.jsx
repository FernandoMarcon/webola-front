...
import Select__Overlay from "../../Select__Overlay"; // plasmic-import: qipNarTFjpY/component
import Select__Option from "../../Select__Option"; // plasmic-import: fhsOoWbxDLX/component
import "@plasmicapp/react-web/lib/plasmic.css";
import projectcss from "./plasmic_blank_project.module.css"; // plasmic-import: jkYJ3dfQP9Jr9rELTBAbk6/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: KMpDeVQrT8c/css
import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: EPReORVf1PA/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: I8dlBdQvuMC/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option__zpyo0)}
            value={"value1"}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__chkXv)}
            value={"value2"}
          >
            {"Option 2"}
          </Select__Option>
