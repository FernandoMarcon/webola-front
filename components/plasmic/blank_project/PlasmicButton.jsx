...
import sty from "./PlasmicButton.module.css"; // plasmic-import: y4rQ8e0NIxd/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: tHSzZDpPq79/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: 6FlNcJ1VCNE/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__ldhDk)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon4Icon
                className={classNames(projectcss.all, sty.svg__jAukb)}
                role={"img"}
              />
            ),
