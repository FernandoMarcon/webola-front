...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: 8uTxanxZOr1/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: KMpDeVQrT8c/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__tyYlk)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__vt7De)}
              />
            </React.Fragment>
          ),
